        ...
        <div className=" flex flex-col gap-10 ">
          <div className="flex flex-col gap-5">
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="relative p-3 flex items-center justify-center">
                  <img
                    src="http://magento2.magentech.com/themes/sm_shopping/pub/media/catalog/product/cache/e9bcb962a9408957578e6af2c852a0c4/f/a/fas-7.jpg"
                    alt=""
              ...
              <div className="relative p-3 flex items-center justify-center">
                  <img
                    src="http://magento2.magentech.com/themes/sm_shopping/pub/media/catalog/product/cache/e9bcb962a9408957578e6af2c852a0c4/f/a/fas-1.jpg"
                    alt=""
                    className="min-w-[180px]"
                  />
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white mb-5 col-span-1 w-full slideOverlay p-3 flex flex-col xl:flex-row gap-2">
                <div className="relative p-3 flex items-center justify-center">
                  <img
                    src="http://magento2.magentech.com/themes/sm_shopping/pub/media/catalog/product/cache/e9bcb962a9408957578e6af2c852a0c4/f/a/fas-13_2.jpg"
                    alt=""
                    className="min-w-[180px]"
                  />
              ...
              <div className="relative p-3 flex items-center justify-center">
                  <img
                    src="http://magento2.magentech.com/themes/sm_shopping/pub/media/catalog/product/cache/e9bcb962a9408957578e6af2c852a0c4/f/a/fas-12_1.jpg"
                    alt=""
                    className="min-w-[180px]"
                  />
...
export default FashionDoubleSlider;
